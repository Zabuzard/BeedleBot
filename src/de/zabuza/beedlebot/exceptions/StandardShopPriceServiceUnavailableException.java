...
/**
 * Exception that is thrown whenever the service used to fetch standard shop
 * price data of an item is unavailable such that a connection could not be
 * established.
 * 
...
public final class StandardShopPriceServiceUnavailableException extends IllegalStateException {
	 ...
	 * service used to fetch standard shop price data of an item is unavailable
